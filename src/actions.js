...
function requestRemoveArticle(id){
  return { type: REQUEST_REMOVE_ARTICLE, id }
}

export const REQUEST_REMOVE_ARTICLE_SUCCESS = 'REQUEST_REMOVE_ARTICLE_SUCCESS'
function requestRemoveArticleSuccess(id){
  return { type: REQUEST_REMOVE_ARTICLE_SUCCESS, id }
}
